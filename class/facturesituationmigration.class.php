                        ...
                        foreach ($cycle_infos as $situcounter => $facture_infos):
                            ...
                            if(intval($situcounter) > 1):
                                ...
                                foreach($facture_infos['lines'] as $line_id => $line_infos): 
                                    ...
                                    $cycle_array[$cycle_ref][$situcounter]['lines'][$line_id]['line_percent'] = number_format(floatval($line_infos['line_percent']) - floatval($cycle_array[$cycle_ref][$situcounter_before]['lines'][$line_infos['fk_prev_id']]['line_percent']),4,'.','');
                                    $cycle_array[$cycle_ref][$situcounter]['lines'][$line_id]['ligne_total_ht'] = number_format(floatval($line_infos['ligne_total_ht']) - floatval($cycle_array[$cycle_ref][$situcounter_before]['lines'][$line_infos['fk_prev_id']]['ligne_total_ht']),8,'.','');
                                    $cycle_array[$cycle_ref][$situcounter]['lines'][$line_id]['ligne_total_tva'] = number_format(floatval($line_infos['ligne_total_tva']) - floatval($cycle_array[$cycle_ref][$situcounter_before]['lines'][$line_infos['fk_prev_id']]['ligne_total_tva']),8,'.','');
                                    $cycle_array[$cycle_ref][$situcounter]['lines'][$line_id]['ligne_total_ttc'] = number_format(floatval($line_infos['ligne_total_ttc']) - floatval($cycle_array[$cycle_ref][$situcounter_before]['lines'][$line_infos['fk_prev_id']]['ligne_total_ttc']),8,'.','');

                                    $cycle_array[$cycle_ref][$situcounter]['lines'][$line_id]['multicurrency_ligne_total_ht'] = number_format(floatval($line_infos['multicurrency_ligne_total_ht']) - floatval($cycle_array[$cycle_ref][$situcounter_before]['lines'][$line_infos['fk_prev_id']]['multicurrency_ligne_total_ht']),8,'.','');
                                    $cycle_array[$cycle_ref][$situcounter]['lines'][$line_id]['multicurrency_ligne_total_tva'] = number_format(floatval($line_infos['multicurrency_ligne_total_tva']) - floatval($cycle_array[$cycle_ref][$situcounter_before]['lines'][$line_infos['fk_prev_id']]['multicurrency_ligne_total_tva']),8,'.','');
                                    $cycle_array[$cycle_ref][$situcounter]['lines'][$line_id]['multicurrency_ligne_total_ttc'] = number_format(floatval($line_infos['multicurrency_ligne_total_ttc']) - floatval($cycle_array[$cycle_ref][$situcounter_before]['lines'][$line_infos['fk_prev_id']]['multicurrency_ligne_total_ttc']),8,'.','');
